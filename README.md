...
- **Web viewer** — Vite + TypeScript + [Three.js](https://threejs.org/) in [web/](web/), with the ten demos of the 2D viewer ported to 3D: **Particles**, **Ballistics**, **Springs**, **Buoyancy**, **Collision**, **Resting**, **Cables**, **Rods**, **Cube** (a real cube of rods) and **Bridge**, plus **Cloth**, the first 3D-only demo: a sheet of rods pinned along its top edge
