...
- **Web viewer** — Vite + TypeScript + [Three.js](https://threejs.org/) in [web/](web/), with the ten demos of the 2D viewer ported to 3D: **Particles**, **Ballistics**, **Springs**, **Buoyancy**, **Collision**, **Resting**, **Cables**, **Rods**, **Cube** (a real cube of rods) and **Bridge**, plus two 3D-only demos: **Cloth**, a sheet of rods pinned along its top edge, and **Pile**, a mound of colliding particles that grows by 100 at a time to load the engine while the Profiler is open
